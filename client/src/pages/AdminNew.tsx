...
import type { Movie, InsertMovie, Server, InsertServer } from '@shared/schema';
  ...
  const handleEdit = async (movie: Movie) => {
    ...
    try {
      ...
      form.reset({
        ...
        servers: servers.length > 0 ? servers.map((s: Server) => ({
          name: s.name,
          url: s.url,
                                ...
                                <FormField
                                  ...
                                  render={({ field }) => (
                                    <FormItem className="flex-1">
                                      ...
                                      <FormControl>
                                        <Input {...field} placeholder="HD, Full HD..." className="bg-dark-primary border-gray-600 text-white" />
                                      </FormControl>
                                      <FormMessage />
                                    </FormItem>
                                  )}
